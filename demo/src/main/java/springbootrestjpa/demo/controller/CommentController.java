package springbootrestjpa.demo.controller;
...
import springbootrestjpa.demo.exception.ResourceNotFoundException;
import springbootrestjpa.demo.model.Comment;
import springbootrestjpa.demo.repository.CommentRepository;
...
public class CommentController {
	...
	public Comment updateComment(@PathVariable(value = "id") Long commentId, @RequestBody Comment commentDetails) {
		...
		comment.setId(commentDetails.getId());
